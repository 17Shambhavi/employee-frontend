...
function Login({ onLogin }) {
    ...
    const handleLogin = async () => {
        ...
        setLoading(true);
        try {
            const res = await fetch('https://employee-management-sb6o.onrender.com/api/auth/login', {
                method: 'POST',
    ...
    const sendOtp = async () => {
        ...
        try {
            const res = await fetch('https://employee-management-sb6o.onrender.com/api/password/forgot-password', {
    ...
    const verifyOtp = async () => {
        ...
        setForgotLoading(true);
        try {
            const res = await fetch('https://employee-management-sb6o.onrender.com/api/password/verify-otp', {
                method: 'POST', headers: { 'Content-Type': 'application/json' },
    ...
    const resetPassword = async () => {
        ...
        setForgotLoading(true);
        try {
            const res = await fetch('https://employee-management-sb6o.onrender.com/api/password/reset-password', {
                method: 'POST', headers: { 'Content-Type': 'application/json' },

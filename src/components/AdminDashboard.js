...
function AdminDashboard({ token, onLogout }) {
    ...
    const loadEmployees = async () => {
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/admin/employees', { headers: { 'Authorization': 'Bearer ' + token } });
        const data = await res.json(); setEmployees(data);
    };
    const loadPendingLeaves = async () => {
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/admin/leaves/pending', { headers: { 'Authorization': 'Bearer ' + token } });
        if (res.ok) { const data = await res.json(); setPendingLeaves(data); setStatLeaves(data.length); }
    };
    const loadTodayAttendance = async () => {
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/admin/attendance/today', { headers: { 'Authorization': 'Bearer ' + token } });
        if (res.ok) { const data = await res.json(); setStatPresent(data.presentCount || 0); }
    };
    const loadInsights = async () => {
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/admin/attendance/insights', { headers: { 'Authorization': 'Bearer ' + token } });
        if (res.ok) { const data = await res.json(); setInsights(data); }
    };
    const loadHolidays = async () => {
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/holidays', { headers: { 'Authorization': 'Bearer ' + token } });
        if (res.ok) { const data = await res.json(); setHolidays(data); }
    };
    const loadProjects = async () => {
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/projects', { headers: { 'Authorization': 'Bearer ' + token } });
    ...
    const addHoliday = async () => {
        ...
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/holidays', { method: 'POST', headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + token }, body: JSON.stringify(newHoliday) });
    ...
    const deleteHoliday = async (id) => {
        ...
        await fetch('https://employee-management-sb6o.onrender.com/api/holidays/' + id, { method: 'DELETE', headers: { 'Authorization': 'Bearer ' + token } });
        loadHolidays();
    };
    const addProject = async () => {
        if (!newProject.projectName || !newProject.employeeId) { setProjectMsg('error:Project name and employee required!'); return; }
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/projects', { method: 'POST', headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + token }, body: JSON.stringify({ ...newProject, employeeId: parseInt(newProject.employeeId) }) });
    ...
    const deleteProject = async (id) => {
        ...
        await fetch('https://employee-management-sb6o.onrender.com/api/projects/' + id, { method: 'DELETE', headers: { 'Authorization': 'Bearer ' + token } });
        loadProjects();
    };
    ...
    const addEmployee = async () => {
        const res = await fetch('https://employee-management-sb6o.onrender.com/api/admin/employees', { method: 'POST', headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + token }, body: JSON.stringify({ ...newEmp, salary: parseFloat(newEmp.salary) }) });
        if (res.ok) {
            const saved = await res.json();
            if (newUsername && newPassword) await fetch('https://employee-management-sb6o.onrender.com/api/auth/register', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ username: newUsername, password: newPassword, employeeId: String(saved.id) }) });
    ...
    const deleteEmployee = async (id) => {
        ...
        await fetch('https://employee-management-sb6o.onrender.com/api/admin/employees/' + id, { method: 'DELETE', headers: { 'Authorization': 'Bearer ' + token } });
        loadEmployees();
    };
    const approveLeave = async (id) => { await fetch('https://employee-management-sb6o.onrender.com/api/admin/leave/' + id + '/approve', { method: 'PUT', headers: { 'Authorization': 'Bearer ' + token } }); loadPendingLeaves(); };
    const rejectLeave = async (id) => { await fetch('https://employee-management-sb6o.onrender.com/api/admin/leave/' + id + '/reject', { method: 'PUT', headers: { 'Authorization': 'Bearer ' + token } }); loadPendingLeaves(); };
